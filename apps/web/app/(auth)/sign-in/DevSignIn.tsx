...
/**
 * DEV / DEMO sign-in — a mock two-step screen that sets the dev session cookie.
 * Used only when Supabase auth is NOT configured. See SupabaseSignIn for the
 * real email/password + MFA flow.
 */
